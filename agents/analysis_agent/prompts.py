...
Your output must be in the following format strictly. Replace <target_url> with the given application url and add relevant test functions. Ensure that each newly added test function includes proper try-except blocks, storing the output or error messages in self.results using the test name as the key.
